...
export default function notFound() {
  return (
    <div className="h-screen w-screen flex items-center not-found container">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        ...
        <div className="max-w-lg">
          <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2395 1800" width="400">
            ...
            ></path>
            <ellipse className="cls-7" cx="1452.5" cy="998.5" rx="153" ry="117"></ellipse>
            ...
            ></path>
            <path className="cls-13" d="M1454.74,1016.08s2.76,17.42-17.24,15.42"></path>
            <path className="cls-13" d="M1455.63,1017.08s-2.76,17.42,17.24,15.42"></path>
            ...
            ></path>
            <circle className="cls-9" cx="395.47" cy="335.18" r="65.13"></circle>
            <path
              className="cls-17"
